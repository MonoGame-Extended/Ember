...
public static class ImGuiRenderer
{
    ...
    // Textures
    private static Dictionary<ImTextureID, TextureInfo> _textures;
    private static int _nextTexId = 1;
    ...
    private static void SetupBackendCapabilities()
    {
    ...
    public static unsafe ImTextureRef BindTexture(Texture2D texture)
    {
    ...
    public static  void UnbindTexture(ImTextureRef textureRef)
    {
    ...
    public static  void UpdateTexture(ImTextureDataPtr textureData)
    {
    ...
    private static unsafe void CreateTexture(ImTextureDataPtr textureData)
    {
    ...
    private static unsafe void UpdateTextureData(ImTextureDataPtr textureData)
    {
    ...
    private static  void DestroyTexture(ImTextureDataPtr textureData)
    {
        IntPtr texId = textureData.GetTexID();
        if (_textures.TryGetValue(texId, out TextureInfo textureInfo))
        {
    ...
    private static  unsafe void ProcessTextureUpdates(ImDrawDataPtr drawData)
    {
    ...
    private static  Effect UpdateEffect(Texture2D texture)
    {
        ImGuiIOPtr io = ImGui.GetIO();
    ...
    private static  unsafe void RenderDrawData(ImDrawData* drawData)
    {
    ...
    private static  unsafe void UpdateBuffers(ImDrawData* drawData)
    {
    ...
    private static  unsafe void RenderCommandLists(ImDrawData* drawData)
    {
