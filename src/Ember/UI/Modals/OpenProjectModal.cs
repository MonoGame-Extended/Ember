...
/// <summary>
/// Result returned by the project selection modal
/// </summary>
/// <param name="Status">The result status of the modal operation</param>
/// <param name="SelectedProject">The selected project file item, if any</param>
public record OpenProjectModalResult(ModalResult Status, FileItem? SelectedProject);

/// <summary>
/// Modal for selecting project files using the unified file browser
/// </summary>
public static class OpenProjectModal
{
    /// <summary>
    ...
    public static void Open(string initialDirectory, Action<OpenProjectModalResult> onClose)
    {
        FileBrowserModal.OpenProjectSelector(initialDirectory, (result) =>
        {
            OpenProjectModalResult projectResult = new(result.Status, result.SelectedItem);
            onClose(projectResult);
        });
    }

    /// <summary>
    /// Draws the project selection modal
    /// </summary>
...
//     private static Action<OpenProjectModalResult> s_onClose;
...
//     public static void Close(OpenProjectModalResult result)
//     {
//         if (s_onClose != null)
//         {
//             s_onClose(result);
...
//         if (s_shouldOpen)
//         {
//             ImGui.OpenPopup(SR.Popup_OpenProjectModal);
//             s_shouldOpen = false;
//         }
...
//         if (ImGui.BeginPopupModal(SR.Popup_OpenProjectModal, null, modalFlags))
//         {
...
//             {
//                 OpenProjectModalResult result = new(ModalResult.Success, s_selectedFileItem);
//                 Close(result);
//             }
//             ImGui.EndDisabled();
...
//             {
//                 OpenProjectModalResult result = new(ModalResult.Cancel, null);
//                 Close(result);
//             }
...
//             foreach (string file in Directory.GetFiles(s_currentDirectory, "*.ember", SearchOption.TopDirectoryOnly))
//             {
