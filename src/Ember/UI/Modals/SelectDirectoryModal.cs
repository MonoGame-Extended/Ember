...
/// <summary>
/// Result returned by the directory selection modal
/// </summary>
/// <param name="Status">The result status of the modal operation</param>
/// <param name="SelectedDirectory">The selected directory item, if any</param>
public record SelectDirectoryModalResult(ModalResult Status, FileItem? SelectedDirectory);

/// <summary>
/// Modal for selecting directories using the unified file browser
/// </summary>
public static class SelectDirectoryModal
{
    /// <summary>
    /// Opens the directory selection modal
    /// </summary>
    ...
    {
        FileBrowserModal.OpenDirectorySelector(initialDirectory, (result) =>
        {
            SelectDirectoryModalResult directoryResult = new(result.Status, result.SelectedItem);
            onClose(directoryResult);
        });
    }

    /// <summary>
    /// Draws the directory selection modal
    /// </summary>
