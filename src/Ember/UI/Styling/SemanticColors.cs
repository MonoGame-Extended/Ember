...
public static class SemanticColors
{
    ...
    public static class Success
    {
        ...
        public static Vector4 Primary => CurrentPalette.Green;

        /// <summary>Subtle success color for background highlights and low-emphasis success states.</summary>
        public static Vector4 Background => ColorUtils.WithOpacity(CurrentPalette.Green, 0.15f);

        /// <summary>Success color for borders and outlines around success-related UI elements.</summary>
        public static Vector4 Border => ColorUtils.WithOpacity(CurrentPalette.Green, 0.4f);
    }
    ...
    public static class Warning
    {
        ...
        public static Vector4 Primary => CurrentPalette.Yellow;

        /// <summary>Subtle warning color for background highlights and low-emphasis warning states.</summary>
        public static Vector4 Background => ColorUtils.WithOpacity(CurrentPalette.Yellow, 0.15f);

        /// <summary>Warning color for borders and outlines around warning-related UI elements.</summary>
        public static Vector4 Border => ColorUtils.WithOpacity(CurrentPalette.Yellow, 0.4f);
    }
    ...
    public static class Error
    {
        ...
        public static Vector4 Primary => CurrentPalette.Red;

        /// <summary>Subtle error color for background highlights and low-emphasis error states.</summary>
        public static Vector4 Background => ColorUtils.WithOpacity(CurrentPalette.Red, 0.15f);

        /// <summary>Error color for borders and outlines around error-related UI elements.</summary>
        public static Vector4 Border => ColorUtils.WithOpacity(CurrentPalette.Red, 0.4f);
    }
    ...
    public static class Info
    {
        ...
        public static Vector4 Primary => CurrentPalette.Blue;

        /// <summary>Subtle information color for background highlights and low-emphasis informational states.</summary>
        public static Vector4 Background => ColorUtils.WithOpacity(CurrentPalette.Blue, 0.15f);

        /// <summary>Information color for borders and outlines around informational UI elements.</summary>
        public static Vector4 Border => ColorUtils.WithOpacity(CurrentPalette.Blue, 0.4f);
    }
    ...
    public static class Primary
    {
        ...
        public static Vector4 Main => CurrentPalette.Blue;

        /// <summary>Secondary primary color for supporting elements and complementary accents.</summary>
        public static Vector4 Secondary => CurrentPalette.Sapphire;
    ...
    public static class Secondary
    {
        ...
        public static Vector4 Main => CurrentPalette.Lavender;

        /// <summary>Muted secondary color for supporting elements and subtle accents.</summary>
        public static Vector4 Muted => CurrentPalette.Mauve;

        /// <summary>Subtle secondary color for background highlights and low-emphasis secondary states.</summary>
        public static Vector4 Background => ColorUtils.WithOpacity(CurrentPalette.Lavender, 0.15f);
    }
